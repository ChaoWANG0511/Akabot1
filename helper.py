...
def Nest_Net(img_rows, img_cols, color_type=1, num_class=1, deep_supervision=False):
    ...
    conv1_1 = standard_unit(img_input, stage='11', nb_filter=nb_filter[0])  # 大小不变：96，32 filters
    pool1 = MaxPooling2D((2, 2), strides=(2, 2), name='pool1')(conv1_1)  # 大小：96变48

    conv2_1 = standard_unit(pool1, stage='21', nb_filter=nb_filter[1])   # 大小不变：48，64 filters
    pool2 = MaxPooling2D((2, 2), strides=(2, 2), name='pool2')(conv2_1)   # 大小：48变24
