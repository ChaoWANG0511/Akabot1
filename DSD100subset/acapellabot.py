...
class AcapellaBot:
    ...
    def isolateVocals(self, path, fftWindowSize, phaseIterations=10):
        ...
        # 幅值反stft转为阿卡贝拉audio数
        newAudio = conversion.spectrogramToAudioFile(newSpectrogram, phase, fftWindowSize=fftWindowSize, phaseIterations=phaseIterations)   # phase?
...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights", default="weights_cus.h5", type=str, help="h5 file to read/write weights to")
